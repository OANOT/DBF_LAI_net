...
import argparse
import os
from data_utils.WheatDataLoader import ScannetDatasetWholeScene
from data_utils.wheat_util import g_label2color
import torch
import logging
...
def parse_args():
    ...
    parser.add_argument('--log_dir', type=str, default='pointnet2_sem_seg2', help='experiment root')
...
def main(args):
    ...
    root = 'data/wheat/wheat_seg_data/'
